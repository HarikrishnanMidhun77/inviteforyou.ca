...
export default ({
  ...
  const defaultTestimonials = [
    {
      imageSrc: "https://i.ibb.co/NLB8vXt/testimonial1.jpg",
      profileImageSrc: "https://i.ibb.co/CWBDpgV/testi-avatar.jpg",
      quote:
        "Took us less than 5mts to make our very own wedding website! And guests just loved it! Highly Recommended!",
      customerName: "Johan Hale",
      customerTitle: "Collingwood",
    },
    {
      imageSrc: "https://i.ibb.co/X5CSPzR/testimonial2.jpg",
      profileImageSrc: "https://i.ibb.co/NmLwnn7/testi-avatar2.jpg",
      quote:
        "The guests absolutely loved the invite we created and wouldn't stop talking about it!",
      customerName: "Valacia Cuppy",
      customerTitle: "Mississauga",
    },
  ];
